...
public class GroupAssetRequest {
    ...
    public String Spare_6;
    public String Multiple;
    public String Memo;
    public String MemoValue;
    public int IMPROV_USEFULLIFE;
	...
	public void setINTEGRIFY_ID(String iNTEGRIFY_ID) {
		INTEGRIFY_ID = iNTEGRIFY_ID;
	}
	...
	public double getWh_Tax_Value() {
		return Wh_Tax_Value;
	}
	public void setWh_Tax_Value(double wh_Tax_Value) {
		Wh_Tax_Value = wh_Tax_Value;
	}
	...
	public int getIMPROV_USEFULLIFE() {
		return IMPROV_USEFULLIFE;
	}
	public void setIMPROV_USEFULLIFE(int iMPROV_USEFULLIFE) {
		IMPROV_USEFULLIFE = iMPROV_USEFULLIFE;
	}
	...
	public double getTotal_CostPrice() {
		return Total_CostPrice;
	}
	public void setTotal_CostPrice(double total_CostPrice) {
