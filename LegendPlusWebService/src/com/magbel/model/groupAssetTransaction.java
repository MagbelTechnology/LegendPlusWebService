...
@XmlRootElement (name="groupAssetTransaction")
public class groupAssetTransaction {
	 private String integrifyId;
	   ...
	   public groupAssetTransaction()  
	    {
	          
	    }

		public groupAssetTransaction(String integrifyId,String description,String registrationNo,String vendorAC, String supplierName,
